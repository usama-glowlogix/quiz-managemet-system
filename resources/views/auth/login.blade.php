...
<body>
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center">
                        <span class="db"><img src="{{asset('/admin_files/assets/images/app-logo.png')}}" alt="logo" /></span>
                    </div>
                    <!-- Form -->
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <button class="btn btn-info" id="to-recover" type="button" onclick="forgotPassword()"><i class="fa fa-lock m-r-5"></i>@if (Route::has('password.request'))
    ...
    <!-- ============================================================== -->
    <!-- All Required js -->
    <script>function forgotPassword(){
